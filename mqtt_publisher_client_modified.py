...
client = mqtt.Client("IOT_pub_206964207_YY444", clean_session=False) # create new client instance
...
pub_topic= "IOT/class/house/sensor/1/test"

# Next 2 loops will publishing 40 messages to one topic(house) and 2 subtopics(sensor_0 and sensor_1)
client.publish(pub_topic,"my 'retained' test message 1",1,True)
# for j in range(2):
#         for i in range(20):
